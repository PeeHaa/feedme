...
use PeeHaa\FeedMe\Validator\Request\LogIn;
...
class LogInTest extends TestCase
{
    ...
    {
        /** @var Result $result */
        $result = wait((new LogIn())->validate('{"foo":'));
    ...
    {
        /** @var Result $result */
        $result = wait((new LogIn())->validate('{"foo": "bar"}'));
    ...
    public function testValidateReturnsFailureOnInvalidId(): void
    {
        ...
        /** @var Result $result */
        $result = wait((new LogIn())->validate(json_encode($this->validRequestData)));
