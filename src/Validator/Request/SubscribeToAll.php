...
use PeeHaa\FeedMe\Validator\Json\Schema\SubscribeToAllRequest;
use PeeHaa\FeedMe\Validator\Request\SubscribeToAll\Id;
use PeeHaa\FeedMe\Validator\Request\SubscribeToAll\Type;
use function Amp\call;

final class SubscribeToAll implements Rule
{
    /**
     * @param mixed $value
